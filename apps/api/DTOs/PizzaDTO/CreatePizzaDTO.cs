...
namespace CaseEstudo1.DTOs
{
    public class CreatePizzaDTO
    {
        ...
        [StringLength(100, ErrorMessage = "O nome da bebida pode ter no máximo 100 caracteres.")]
        public string? NomeBebida { get; set; }

        [Range(0.01, 999.99, ErrorMessage = "O preço da bebida deve estar entre 0.01 e 999.99.")]
